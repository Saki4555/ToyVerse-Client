    ...
    return (
         ...
         <div className="my-container mb-20">
            ...
            <div className='grid md:grid-cols-3 gap-10'>
                <div data-aos="fade-right" className='border py-5 px-8 w-full lg:w-96 shadow-2xl'>
                    <div className=''>
                        ...
                        <div className='mt-5'>
                            ...
                            <div className='md:flex items-center mt-3'>
                                ...
                                <div className='bg-1 text-white py-1 lg:px-5'>
                                    <p>Customer1</p>
                ...
                <div data-aos="zoom-in-up" className='border py-5 px-8 w-full lg:w-96 shadow-2xl'>
                    <div className=''>
                        <div className='flex items-center gap-5 p-5 bg-gray-100'>
                ...
                <div data-aos="fade-left" className='border py-5 px-8 w-full lg:w-96 shadow-2xl'>
                    <div className=''>
                        <div className='flex items-center gap-5 p-5 bg-gray-100'>
